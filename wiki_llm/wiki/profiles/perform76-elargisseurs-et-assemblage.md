...
Tous les profils de cette page sont documentés **uniquement sur les dormants 76171 et 76172**,
les deux dormants neufs sans aile (cahier technique, p. 19 et 20). Aucun ne se monte sur un
dormant rénovation ni sur le 76180.

Voir [Dormants PERFORM76](/profiles/perform76-dormants.md).

# Cotes des élargisseurs

Les quatre élargisseurs, en mm, relevés sur le cahier technique (p. 19).
...
**Le renfort acier n'est disponible que sur les 76702 et 76703**, et seulement en option (cahier
technique, p. 19). Les deux petits élargisseurs n'en reçoivent pas. À partir de 60 mm
d'élargissement, la question du renfort se pose donc systématiquement au chiffrage.

Le 76703 reçoit **deux** renforts V314.Z, contre un seul pour le 76702.

# Cotes des profils d'assemblage

Profils d'assemblage pour dormants 76171 et 76172, en mm, relevés sur le cahier technique
(p. 20).
...
L'**adaptateur 76821 est requis par les trois poteaux d'angle** : il apparaît sur chacun des
trois schémas de poteau (cahier technique, p. 20). Il ne se commande donc jamais seul dans un
angle.
...
Les trois poteaux d'angle, en mm, relevés sur le cahier technique (p. 20).

| Poteau | Angle | Référence | Largeur (mm) | Hauteur (mm) | Adaptateur requis |
| --- | --- | --- | --- | --- | --- |
| Poteau d'angle à 90° | 90° | 8355 | 104 | 88 | 76821 |
| Poteau d'angle à 135° | 135° | 8356 | 54 | 88 | 76821 |
| Poteau d'angle variable | variable | 8340 + 8341 | 84 × 84 | 88 | 76821 |

(schéma: raw/cahier-technique-perform76-2026-09-02-cc03.pdf, p. 20)

Précisions du schéma (cahier technique, p. 20) :
...
- les trois poteaux ont la même hauteur de 88 mm et une cote de reprise de 12 mm
...
Relevé sur le cahier technique (p. 19 et 20).

Les références **8340, 8341, 8355 et 8356** sortent de la numérotation 76xxx de la gamme : ce
sont vraisemblablement des profils de la bibliothèque
[KÖMMERLING](/fournisseurs/kommerling.md) et non des profils propres à la PERFORM76. Le cahier
ne le précise pas — à confirmer.

...
| Type | Référence |
| --- | --- |
| Pivot d'angle P 6/150 | 263858 |
| Pivot d'angle P 6/150, réglable en compression | 445171 |
...
Ces références sont données sans dimension ni schéma de fonctionnement au-delà de leur position
sur la planche de configuration qui les emploie — voir la page de configuration correspondante

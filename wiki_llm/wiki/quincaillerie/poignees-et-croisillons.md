...
| Modèle | PERFORM | HYBRIDE | LUMINE | TEXTURAL |
| --- | --- | --- | --- | --- |
| TOULON sur plaque | oui | non | oui | non |
| Sécustik® TOULON avec rosace | oui | oui | oui | oui |
| ATLANTA plaque large | oui | oui | oui | oui |
| ATLANTA plaque étroite | oui | oui | oui | oui |
| Sécustik® ATLANTA avec rosace | oui | oui | oui | oui |
| Technal® BERLIN | non | non | en option | non |

Relevé sur le catalogue général (p. 7, 11, 15 et 23). Les finitions courantes sont inox, blanc ou
laiton, avec le noir et le 7016 en option selon les modèles.
...
| --- | --- | --- | --- | --- |
| Sécustik® ATLANTA | oui | - | - | - |
| Sécustik® TOULON | oui | - | - | - |
| SEOUL (cuvette de tirage) | oui | - | - | - |
| DEHLI (poignée encastrée) | oui | - | - | - |
| SYDNEY | - | en option, ouvrant principal | en option, ouvrant principal | - |
| MILAN | - | en option, semi-fixe | en option, semi-fixe | - |
| Technal® SHANGHAI | - | - | en option, ouvrant principal | - |
| Technal® PEKIN | - | - | en option, ouvrant principal | - |
| Technal® GRENADE | - | - | en option, semi-fixe | - |
| Technal® BERLIN | - | - | en option | en option |
| Technal® ANTIBES | - | - | en option | en option |
| Technal® OSAKA (poignée de tirage) | - | - | - | en option |
| Technal® KOBE (bouton de manœuvre) | - | - | - | en option |
| Technal® TOKYO (poignée droite) | - | - | - | en option |
| Technal® KYOTO (poignée inclinée) | - | - | - | en option |

Voir [Coulissants aluminium](/gammes/coulissants-aluminium.md) et
[INNOSLIDE](/gammes/innoslide.md).

# Cotes des croisillons

Largeurs de croisillons disponibles, en mm, relevées sur le catalogue général PROFERM (p. 7, 11,
15, 17 et 23).

| Croisillon | Largeur (mm) | Croix |
| --- | --- | --- |
| Standard 10 | 10 | oui |
| Standard 18 | 18 | oui |
| Standard 26 | 26 | oui |
| Standard 45 | 45 | oui |
| Laiton 8 | 8 | sans croix |
| Plomb 8 | 8 | sans croix |
...
- **moustiquaire** à cadre fixe, permettant de laisser la fenêtre ouverte, fermée ou ouvrant
  battant
- **soubassement** mouluré en option, existe aussi en plat
- **verrou de sécurité** sur les coulissants, en option, disponible en blanc ou noir (catalogue
  général, p. 17)

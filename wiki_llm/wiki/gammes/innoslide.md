...
type: Gamme
title: INNOSLIDE
description: Coulissant PVC à frappe de PROFERM, sans soulèvement de l'ouvrant, rattaché à la gamme PERFORM.
tags: [pvc, coulissant, innoslide, perform]
status: stable
sources:
...
Dimensions limites et épaisseur de vitrage de l'INNOSLIDE, en mm, relevées sur le catalogue
général PROFERM (p. 8).

| Caractéristique | Valeur (mm) | Condition |
| --- | --- | --- |
| Largeur mini | 1 500 | - |
| Largeur maxi | 3 200 | soudure grain d'orge sur ouvrant et dormant |
| Largeur maxi | 4 200 | dormant ébavuré, ouvrant grain d'orge |
| Hauteur maxi | 2 400 | dans les deux configurations |
| Épaisseur de vitrage maxi | 41 | - |
| Largeur mini pour la fonction SoftOpen | 1 970 | - |

(schéma: raw/depliant-innoslide-2024-01.pdf, p. 2)

La **hauteur maximale de 2 400 mm ne figure pas au catalogue général**, qui ne donne que des
...
L'INNOSLIDE est certifié **A\*4 / E\*7A / V\*B3** et annoncé à un Uw de 1,3 W/m²K (catalogue
général, p. 8). Son classement à l'eau (E\*7A) et au vent (V\*B3) est inférieur à celui des
fenêtres de la gamme PERFORM, classées E\*9A / V\*A3.
...
| Blanc 9016 intérieur / Gris 7016 grainé extérieur, plaxé | 2 faces |
| Gris 7016 grainé, plaxé | 2 faces |
...
Composants nommés : galets K sur roulements à billes montés sur les verrouilleurs, verrouilleur
médian, chariot, dispositif anti-basculement, gâches côté dormant, renvois d'angle,
stabilisateur. Détail dans [Roto Patio Inowa](/quincaillerie/roto-patio-inowa.md).
...
| Composant | Dépliant, janvier 2024 | Catalogue général, janvier 2026 |
| --- | --- | --- |
| Structure de la menuiserie | 15 ans | 15 ans |
| Ferrure Roto | 10 ans sur le fonctionnement | 10 ans sur le fonctionnement |
| Vitrage | 10 ans | 10 ans |
| Volet roulant | **7 ans** | **5 ans** |

Le seul écart porte sur le volet roulant — entrée **CTR-04** du registre
[Contradictions entre sources](/anomalies/contradictions-entre-sources.md). Voir
...
p. 8, 17 et 35
[2] Dépliant INNOSLIDE, édition janvier 2024 — `raw/depliant-innoslide-2024-01.pdf`, p. 2
...
- [Dépliant INNOSLIDE](/sources/depliant-innoslide.md)

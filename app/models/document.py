...
class Document(SQLModel, table=True):
    ...
    source: Optional[str] = Field(default=None, index=True)  # Fournisseur (Proferm, Technal, etc.)
    ...
    coulissant_galandage: Optional[str] = Field(default=None, max_length=8)
...
class DocumentClassificationFields(SQLModel):
    """Champs de classification catalogue (upload / édition)."""
